...
=======
> [!WARNING]  
> This is a **fork** of ReShade, tuned to my own hardware and personal preferences. Check the [Actions tab](https://github.com/LordNyriox/reshade/actions/workflows/build.yml) for builds.
